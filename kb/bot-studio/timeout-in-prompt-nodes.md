> Source: https://console-docs.gupshup.io/docs/timeout-in-prompt-nodes
...
<Image align="center" src="https://files.readme.io/48669bc-pic22.png" />
...
5. Note that the minimum duration is 1 second, and the maximum duration is 60 minutes.
6. Ensure that the fallback connector is properly configured with the desired action for any error or timeout scenarios.
7. Once the journey is deployed, the bot will wait for user input on the prompt node until the timeout duration is reached.
8. Once the timeout elapses, the bot will trigger the fallback path as configured.
