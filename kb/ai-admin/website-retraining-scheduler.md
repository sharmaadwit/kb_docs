> Source: https://console-docs.gupshup.io/docs/website-re-training-scheduler
...
<Image align="center" className="border" border={true} src="https://files.readme.io/bdee6066a26f7be340dd41ba72086e5bf5835277b3f43242d90c77fc4ad76880-Screenshot_2025-06-02_143202.png" />
...
* **Default Training Time for different intervals:**
...
<Image align="center" className="border" border={true} src="https://files.readme.io/cb50281a12ec7729c288e3a7284a34af367c2225dd1049c9b6ebc2a47717ac17-Screenshot_2025-06-02_121020.png" />
...
| Column         | Description                                                       |
| :------------- | :---------------------------------------------------------------- |
| Name           | The unique name given to the scheduler.                           |
| Created On     | The date and time when the scheduler was created.                 |
| Start-End Date | The period during which the scheduler will be active.             |
| Interval       | The frequency of execution (Daily, Weekly, Monthly).              |
| Frequency      | The number of times the scheduler will run based on the interval. |
| Status         | Current state of the scheduler (Active, Inactive, Completed).     |
| Next Training  | The date and time of the next scheduled re-training run.          |
| Action         | Icons to perform actions like Delete, Run, or Pause.              |

<br />

<Image align="center" className="border" border={true} src="https://files.readme.io/c0ce939bac2020991e800b5f4a6eb4d25c728e807170a233c4b51761e4c67cc3-Screenshot_2025-06-02_121034.png" />
