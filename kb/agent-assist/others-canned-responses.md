source_url: https://console-docs.gupshup.io/docs/others-canned-responses
...
## Setup path
- Gupshup Console → **Agent Assist** → **Settings** → **Others** → **Canned Responses**
...
## Steps
1. Open Agent Assist.
2. Open **Settings** → **Others** → **Canned Responses**.
