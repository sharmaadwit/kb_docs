...
Code-backed capabilities that let the AI perform tasks for you
...
What's next?
Manage Skills — Enable, create, and share skills
Agents — Assign skills to focused AI assistants
Recipes — Combine skills into reusable workflow templates
## Previous
Embed an Agent
Manage Skills
