...
Focused AI assistants you configure for a specific job
...
Responses expose a public model alias (for example sa-1.4-mini) and structured token usage: usage.input_tokens, usage.output_tokens, usage.cached_input_tokens, and usage.cache_write_tokens. Intent-classifier tokens from dynamic routing are billed separately and are not included in this usage block.
Info
...
What's next
Create an Agent — step-by-step walkthrough with an interactive demo
Embed an Agent — add your agent to any website or app
Skills — learn about the tools you can assign
Recipes — reusable workflow templates for your agent
Scheduled Tasks — automate work on a recurring schedule
## Previous
Getting Started
Create an Agent
