...
Build a focused AI assistant for a specific job — from first message to API access
Note
...
3
Name your agent and click Create
...
4
Your agent is live — explore the detail page
...
What's next
Add Skills — give your agent the tools it needs
Embed your Agent — add it to any website or external app
Connect Integrations — link Gmail, Sheets, Jira, and more
Agents overview — understand all the features in one place
## Previous
Agents: Overview
Embed an Agent
