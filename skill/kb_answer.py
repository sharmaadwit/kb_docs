...
CONCEPT_REGISTRY: List[Dict] = [
    ...
    },
    {
        ...
        "module_context": ["journey builder", "bot studio", "journey"],
        "source_boosts": {"manage-variables": 9.0, "modify-variable-node": 6.0, "kb/bot-studio/api-node-http-status-code-branching.md": -3.0},
        "source_penalties": {
    ...
    },
    {
        ...
        "aliases": [
            ...
            "save user input", "save the user input",
    ...
    },
    {
        "id": "sms_otp",
        "aliases": [
            "otp", "otp validation", "sms otp", "one time password",
            "otp via sms", "sms one time password", "send otp",
            "otp delivery", "otp not received", "otp setup",
        ],
        "keywords": ["otp", "one time password", "sms otp"],
        "module_context": ["channels", "sms"],
        "source_boosts": {},
        "source_penalties": {
            "api-node-http-status-code-branching": -5.0,
        ...
        "display": "SMS OTP",
        "page_display": "SMS OTP / One-Time Passwords",
        "module": "Channels",
        "related": ["sms_registration"],
    },
    {
        "id": "voice_ai",
        "aliases": [
            "voice ai", "voice channel", "whatsapp voice", "voice sip",
            "pstn", "voice calls", "inbound calls", "outbound calls",
            "sip calls", "voice over whatsapp", "voice call setup",
            "ivr", "dtmf", "voice bot", "voice journey",
        ],
        "keywords": ["voice", "sip", "pstn", "ivr", "dtmf", "inbound", "outbound"],
        "module_context": ["channels", "integrations"],
        "source_boosts": {
            "whatsapp-voice-sip-overview": 5.0,
            "whatsapp-voice-overview-and-inbound-calls": 4.5,
            "whatsapp-voice-sip-inbound-calls": 4.0,
            "whatsapp-voice-sip-outbound-calls": 4.0,
            "whatsapp-voice-outbound-calls-session-and-permissions": 3.5,
            "whatsapp-voice-sip-network-and-media": 3.0,
            "whatsapp-voice-sip-call-permissions-and-errors": 3.0,
            "whatsapp-voice-sip-operations-faq": 3.0,
            "whatsapp-voice-cdr-insights-and-agent-analytics": 2.5,
        },
        "source_penalties": {
            "custom-integrations.md": -3.0,
        },
        "display": "Voice AI / WhatsApp Voice",
        "page_display": "Voice AI / WhatsApp Voice (SIP)",
        "module": "Channels",
        "related": ["custom_integrations"],
    },
    ...
    },
    {
        ...
        "aliases": [
            ...
            "configure an intent", "configure intent", "how to configure an intent",
            "set up an intent", "how do i configure an intent",
        ],
    ...
    # ---- IDK-fix routing concepts (boost the correct EXISTING page) ----
    {
        ...
        "aliases": [
            ...
            "console url", "find console", "console login url",
            "display name pending approval", "whatsapp display name console",
            "delete project console", "kyc documents upload",
            "where to upload kyc", "mfa token validity",
            "api key location", "where is api key", "where to find api key",
            "client id secret", "client id and secret", "where is client id",
            "inbox location", "where is inbox", "find inbox console",
            "where to login gupshup", "gupshup console url", "login to gupshup",
        ],
        "keywords": ["console", "login", "navigate", "api key", "client id", "kyc", "inbox"],
    ...
    {
        "id": "journey_builder_setup",
        "aliases": [
            "journey builder setup", "whatsapp journey setup",
            "bot studio journey setup", "multilingual journey",
            "multilingual journey setup", "prevent journey loops",
            "infinite loop journey", "build journey whatsapp",
            "journey language support", "journey setup guide",
            "prevent infinite loops", "loop prevention journey",
            "building journeys for whatsapp", "building journeys on whatsapp",
            "help me build journeys", "build whatsapp journeys",
            "whatsapp journey components", "inbound customer journey",
            "outbound template journey", "agent handover journey",
        ],
        "keywords": ["journey", "journey builder", "multilingual", "loop", "build journeys",
                     "prevent infinite loops", "loop prevention", "whatsapp journey"],
        "source_boosts": {
            "journey-building-patterns.md": 5.0,
            "consulting-loop-prevention.md": 5.0,
            "about-bot-studio.md": 3.0,
            "nodes.md": 2.5,
        },
        "source_penalties": {},
        "display": "Journey Builder Setup",
        "page_display": "Journey Builder Setup & Best Practices",
        "module": "Journey Builder",
        "related": ["journey_builder_nodes", "bot_deployment"],
    },
    {
        "id": "chat_history",
        "aliases": [
    ...
    },
    {
        "id": "whatsapp_sandbox",
        "aliases": [
            "whatsapp sandbox", "sandbox testing", "test whatsapp number",
            "sandbox tester", "add sandbox tester", "whatsapp test environment",
            "number inactive not opted in", "number not opted in",
            "sandbox error", "inactive number error", "test number setup",
            "sandbox vs production", "go live from sandbox",
        ],
        "keywords": ["sandbox", "tester", "inactive", "opted in", "test number"],
        "source_boosts": {
            "save-deploy-sandbox-go-live": 5.0,
            "whatsapp-error-codes-guide": 3.5,
        },
        "source_penalties": {},
        "display": "WhatsApp Sandbox & Test Environment",
        "page_display": "WhatsApp Sandbox & Test Environment",
        "module": "Bot Studio",
        "related": ["save_deploy", "bot_deployment"],
    },
    {
        "id": "whatsapp_process",
        "aliases": [
    ...
    },
    {
        ...
        "aliases": [
            ...
            "ccx", "console vs ccx", "difference between console and ccx",
            "what is ccx", "ccx vs console", "ccx platform",
            ...
            "cc express whatsapp api",
            "send receive whatsapp via api",
            ...
            "otp service india cc express",
            "cc express modules",
            "whats included in cc express",
            "gupshup console difference",
            "bot studio in cc express",
        ],
        "keywords": ["cc express", "plan", "pricing", "include", "bundle", "console", "wallet", "jb pro",
                     "cc express modules", "cc express setup", "which plan"],
...
_MULTILINGUAL_TERMS: dict = {
    ...
    "fila":          "queue",
    "ajuda":         "help",
    # Portuguese — wallet / billing
    "recarga":           "top-up credits",
    "saldo":             "wallet balance",
    "carteira":          "wallet",
    "cobrança":          "billing charge",
    "inadimplência":     "debt collection",
    "inadimplente":      "overdue payer",
    "nota fiscal":       "invoice",
    "retenção":          "data retention",
    "prazo":             "retention period",
    # Portuguese — agent handoff / assignment
    "transbordo":        "handoff to agent",
    "atribuição":        "assignment",
    "reatribuição":      "re-assignment",
    "retentativa":       "retry",
    "atendimento":       "support session",
    "encerramento":      "session close",
    "equipe":            "team",
    "fila de espera":    "queue",
    "regra de atribuição": "assignment rule",
    "horário comercial": "business hours",
    "tempo limite":      "timeout",
    # Portuguese — messaging / templates
    "janela de 24 horas": "24-hour messaging window",
    "template aprovado": "approved template",
    "carrossel":         "carousel template",
    "pesquisa de satisfação": "satisfaction survey",
    "múltiplas telas":   "multi-screen flow",
    "opt-out":           "opt-out unsubscribe",
    "disparo":           "broadcast send",
    "link tracking":     "link click tracking",
    "categoria":         "template category",
    # Portuguese — journey builder / bot studio
    "nó":                "node",
    "variável":          "variable",
    "condição":          "condition",
    "roteamento":        "routing",
    "fallback":          "fallback",
    "contador":          "counter variable",
    "incrementar":       "increment",
    "objetivo":          "goal",
    "entrada":           "entry point",
    "passo a passo":     "step-by-step guide",
    "tela":              "screen view",
    # Portuguese — account / settings
    "sandbox":           "sandbox test environment",
    "webhook":           "webhook",
    "exportar":          "export",
    "histórico":         "history logs",
    "portabilidade":     "number portability",
    "mascarar":          "mask hide pii",
    "ocultar":           "hide conceal",
    "desativar":         "disable deactivate",
    "bloqueio":          "block ban",
    "blocklist":         "blocklist",
    "publicar":          "publish deploy",
    "ao vivo":           "live production",
    "coexistência":      "coexistence",
    "clonar":            "clone duplicate",
    "desvinculação":     "unlink disconnect",
    "parceiro":          "partner",
    "autenticação de dois fatores": "two-factor authentication 2fa",
    "código de verificação": "verification code otp",
    "senha":             "password",
    "sel de verificação": "verified badge blue tick",
    "selo de verificação": "verified badge blue tick",
    # Portuguese — analytics / reporting
    "relatório":         "report analytics",
    "produtividade":     "productivity",
    "anúncio":           "ad advertisement",
    "retargeting":       "retargeting",
    "multilocatário":    "multi-tenant",
    "provisionamento":   "provisioning",
    "voz":               "voice pstn",
    "página inicial":    "home page dashboard",
    "habilitar":         "enable activate",
    "visualizar":        "view display",
    ...
    "análisis":      "analytics",
    "ayuda":         "help",
    # Spanish — wallet / billing
    "recarga":           "top-up credits",
    "saldo":             "wallet balance",
    "billetera":         "wallet",
    "cobro":             "billing charge",
    "facturación":       "billing invoicing",
    "cobranza":          "debt collection billing",
    "costo":             "cost pricing",
    # Spanish — agent / team
    "colas":             "queues",
    ...
    # Spanish — account / settings
    "sandbox":           "sandbox test environment",
    "probar":            "test try",
    "ambiente de prueba": "test environment",
    "insignia":          "verified badge blue tick",
    "cuenta verificada": "verified account",
    "desconectar":       "disconnect unlink",
    "desvincular":       "unlink disconnect",
    "vincular":          "link connect",
    "archivada":         "archived template status",
    "archivar":          "archive",
    "reactivar":         "reactivate unarchive",
    "eliminar":          "delete remove",
    "en vivo":           "live production",
    "coexistencia":      "coexistence",
    "portabilidad":      "number portability",
    "historial de chats": "chat history logs",
    "atributos":         "attributes profile properties",
    "multilocatario":    "multi-tenant",
    "socio":             "partner",
    "formato de documento": "document format file type",
    "adjunto":           "attachment file",
    ...
    "مساعدة":            "help",
    "وكيل":              "agent",
    # Arabic — account / connect
    "ربط":               "connect link",
    "حساب الأعمال":      "business account",
    "واتساب الأعمال":    "whatsapp business",
    "مطور":              "developer account",
    "موثق":              "verified",
    "شركة":              "company business",
    "المتطلبات":         "requirements",
    "الخطوات الرسمية":   "official steps procedure",
    "منصة":              "platform",
    "خدمة":              "service",
    "ربط العملاء":       "embedded signup",

    # Turkish — bulk / templates
    "toplu mesaj":       "bulk message broadcast",
    "şablon":            "template",
    "onaylı şablon":     "approved template",
    "template kütüphanesi": "template library",
    "mesaj kategorileri": "message categories",
    "kişi listesi":      "contact list recipients",
    "gönderim":          "message delivery send",
    # Turkish — journey / bot / integration
    "entegrasyon":       "integration",
    "konfigürasyon":     "configuration setup",
    "kurulum":           "setup installation",
    "kampanya yöneticisi": "campaign manager",
    # Turkish — account / billing
    "ücretlendirme":     "billing pricing",
    "izin":              "permission opt-in",
    "rıza":              "consent opt-in",
    "üyelik":            "membership partner enrollment",
    "partner":           "partner",
    "doküman":           "documentation",
    "mesaj geçmişi":     "message history chat logs",
    "anket":             "survey",

    # Hindi (Hinglish) — journey builder
    "trigger karein":    "trigger start",
    "starting node":     "entry node starting node",

    # French
    "comment être partenaire": "how to become a partner",
}
...
def _translate_key_terms(query: str) -> str:
    ...
    Covers Portuguese, Spanish, Arabic, Turkish, Hindi (Hinglish), and French.
    Add new language entries to _MULTILINGUAL_TERMS above.
...
def kb_answer(parameters: object = None, context=None, correlation_id: Optional[str] = None, parent_trace_id: Optional[str] = None, **kwargs) -> dict:
    ...
    try:
        ...
        if len(videos) > 1:
            ...
            video_meta["video_ids"] = [v.get("video_id") or v.get("demo_id") for v in videos]
            video_meta["video_sources"] = [v.get("type", "youtube") for v in videos]
        ...
        for _v in videos:
            ...
            elif _v and _v.get("type") == "demoforge":
                # Log DemoForge delivery
                try:
